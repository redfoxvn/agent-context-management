...
2. Build `.acm/architecture/source-map.md` first.
...
Use `.acm/index.md` as the context router.
...
- `.acm/index.md` reflects actual folders in the repo
- `.acm/architecture/source-map.md` maps important areas of code
- `.acm/architecture/system-overview.md` identifies major runtime components
- `.acm/architecture/flows.md` captures important runtime behavior when known
- `.acm/architecture/conventions.md` captures stable conventions when known
- `.acm/product/overview.md` explains product purpose, users, goals, and constraints
- `.acm/product/glossary.md` defines common domain terms
- `.acm/tasks/index.md` exists
- templates are available under `.acm/templates/`
...
1. Read `AGENTS.md`.
2. Use `.acm/index.md` to route context.
3. Read `.acm/agent/context-policy.md` and `.acm/agent/task-workflow.md`.
