...
Use `docs/index.md` for source-of-truth and write locations. Use `docs/agent/task-workflow.md` for task classification and lifecycle.
...
| Level | Use When | Read |
|---|---|---|
| 0 Bootstrap | Starting a session | `AGENTS.md`, `docs/index.md` |
| 1 Routing | Classifying or locating scope | Level 0, `docs/agent/task-workflow.md`, `docs/architecture/source-map.md`, relevant indexes |
